...
public class TaskController {
    ...
    /**
     * Find task by assignee result vo.
    ...
    public ResultVO findTaskByAssignee(@RequestParam("assignee") String assignee) {
        ...
        if (taskList != null && taskList.size() > 0) {
            ...
            resultVO = ResultVO.success("查询成功", null);
        }
    ...
    public ResultVO completeTask(@RequestParam("taskId") String taskId,
        ...
        try {
            ...
            resultVO = ResultVO.fail("提交失败：" + e.getMessage());
            e.printStackTrace();
            return resultVO;
        }
        resultVO = ResultVO.success("提交成功", taskId);
        return resultVO;
    }
}
